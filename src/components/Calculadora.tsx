...
/**
 * Visor + teclado, sem o cabeçalho de recolher/expandir — extraído para ser
 * reaproveitado tanto pela `Calculadora` embutida (abaixo) quanto pelo
 * popover da calculadora no rail do layout largo (RailLateral.tsx).
 */
